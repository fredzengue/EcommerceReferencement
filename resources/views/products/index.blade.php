                        ...
                        <div class="row">
                            ...
                            <div class="ct-topbar-right">
                                ...
                                <ul id="ct-menu-topbar" class="ct-main-menu children-arrow ct-menu-topbar clearfix">
                                    ...
                                    <a href="https://demo.casethemes.net/organio/sign-in/"></span><span>Connexion</span></a></li>
                                    @endif

                                    @if (Route::has('register'))
                                    <li id="menu-item-2240"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2240">
                                    <a href="https://demo.casethemes.net/organio/sign-up/">Inscription</span></a></li>
                                    @endif
                                    @endguest
                                </ul>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="ct-header-navigation">
                                        ...
                                        <li id="menu-item-2231"
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li id="menu-item-2277" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-2277">
                                                    <a href="https://demo.casethemes.net/organio/product-category/fresh-fruits/">
                                ...
                                <div class="header-right-item h-btn-cart"> <i class="caseicon-shopping-cart"></i>
                                    Cart: <span class="widget_cart_counter_header">0 - <span
                                    ...
                                    <div class="widget-content">
                                        <form role="search" method="get" class="woocommerce-product-search"
                                            action="https://demo.casethemes.net/organio/"> <label
                                                ...
                                                name="s" /> <button type="submit" value="Search">Search</button> <input
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul id="menu-menu-footer"
                                                                                        ...
                                                                                        <li id="menu-item-60"
                                                                                            ...
                                                                                            <a
                                                                                                href="https://demo.casethemes.net/organio/"><span>Home</span></a>
                                                                                        </li>
                                                                                        <li id="menu-item-980"
